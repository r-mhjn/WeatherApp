			...
			<SafeAreaView style={styles.container}>
				<View style={styles.pageContainer}>
					<View style={styles.topContainer}>
						...
						<Text style={{ color: '#fff', fontSize: responsiveFontSize(2.5), marginVertical: 2 }}>
						...
						<Text style={{ color: '#fff', fontSize: responsiveFontSize(2) }}>Today</Text>
						...
						<Text style={{ color: '#fff', fontSize: responsiveFontSize(2.5), marginVertical: 6 }}>
					...
					/>
					<View
						style={{ flexDirection: 'row', width: screenWidth * 0.8, marginHorizontal: screenWidth * 0.05 }}
					>
						<View
							style={{
						...
						>
							<Text style={{ color: '#fff', fontSize: responsiveFontSize(8), fontWeight: '100' }}>
